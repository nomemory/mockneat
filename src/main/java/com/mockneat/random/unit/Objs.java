...
import com.mockneat.random.unit.interfaces.RandUnitFromImpl;
import com.mockneat.random.unit.interfaces.RandUnitFromMapKeysImpl;
import com.mockneat.random.unit.interfaces.RandUnitFromMapValuesImpl;
...
public class Objs {
    ...
    public <T extends Enum<?>> RandUnit<T> from(Class<T> enumClass) {
        ...
        return new RandUnitFromImpl<>(rand, arr);
    }
